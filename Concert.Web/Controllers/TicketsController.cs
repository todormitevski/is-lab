...
namespace Concert.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NumberOfPeople,ConcertId")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,NumberOfPeople,ConcertId")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
